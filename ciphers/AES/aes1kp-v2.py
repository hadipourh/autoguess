# Created on Aug 13, 20201
# author: Hosein Hadipour
# contact: hsn.hadipour@gmail.com
# In this equation generator we incorporate the alternative representation of AES's key schedule by Gaëtan Leurent and Clara Pernot in Eurocrypt 2021
...
def aes1kp(R=1):
    ...
    key_sch_connection_relations = [
                         ...
                         'K_1_2_3, SK_1_2_3',
                         'K_1_1_3, SK_1_1_3']
    key_sch_algebraic_relations = [
                         'SK_0_0_3 + K_0_3_0 + K_1_3_0',
                         'K_0_2_0 + SK_0_3_3 + K_1_2_0',
                         'K_0_1_0 + SK_0_2_3 + K_1_1_0',
                         'K_0_0_0 + SK_0_1_3 + K_1_0_0',
                         'K_0_3_3 + K_1_3_2 + K_1_3_3',
    ...
    alternative_representation_key_schedule = [
                        "K_1_3_3 + K_0_3_3 + K_0_3_2 + K_0_3_1 + K_0_3_0 + SK_0_0_3",
                        "K_1_2_3 + K_1_2_2 + K_1_2_1 + K_1_2_0 + K_0_2_3 + K_0_2_1",
                        "K_1_1_3 + K_1_1_1 + K_0_1_3 + K_0_1_2",
                        "K_1_0_3 + K_1_0_2 + K_0_0_3",
                        #############################################################
                        "K_1_2_3 + K_0_2_3 + K_0_2_2 + K_0_2_1 + K_0_2_0 + SK_0_3_3",
                        "K_1_1_3 + K_1_1_2 + K_1_1_1 + K_1_1_0 + K_0_1_3 + K_0_1_1",
                        "K_1_0_3 + K_1_0_1 + K_0_0_3 + K_0_0_2",
                        "K_1_3_3 + K_1_3_2 + K_0_3_3",
                        #############################################################
                        "K_1_1_3 + K_0_1_3 + K_0_1_2 + K_0_1_1 + K_0_1_0 + SK_0_2_3",
                        "K_1_0_3 + K_1_0_2 + K_1_0_1 + K_1_0_0 + K_0_0_3 + K_0_0_1",
                        "K_1_3_3 + K_1_3_1 + K_0_3_3 + K_0_3_2",
                        "K_1_2_3 + K_1_2_2 + K_0_2_3",
                        #############################################################
                        "K_1_0_3 + K_0_0_3 + K_0_0_2 + K_0_0_1 + K_0_0_0 + SK_0_1_3",
                        "K_1_3_3 + K_1_3_2 + K_1_3_1 + K_1_3_0 + K_0_3_3 + K_0_3_1",
                        "K_1_2_3 + K_1_2_1 + K_0_2_3 + K_0_2_2",
                        "K_1_1_3 + K_1_1_2 + K_0_1_3"
    ]
    eqs = '#%s %d Rounds\n' % (cipher_name, R)
    ...
    for r in range(R):
        ...
        for rel in key_sch_connection_relations:
    ...
    for r in range(R):
        ...
        for i in range(4):
            for j in range(4):
                eqs += 'W_%d_%d_%d + K_%d_%d_%d + X_%d_%d_%d\n' % \
                    (r, i, j, r + 1, i, j, r + 1, i, j)
        for rel in key_sch_algebraic_relations:
            updated_relation = rel.replace('K_1', 'K_%d' % (r + 1))
            updated_relation = updated_relation.replace('K_0', 'K_%d' % r)
            eqs += '%s\n' % updated_relation
